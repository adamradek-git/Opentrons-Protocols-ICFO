...
# metadata
metadata = {
    'protocolName': 'Perovskite Protocol Exactly As Written by Higgins',
    'author': 'Martinez',
    'description': 'Protocol is divded into two parts, first part 1. Then Part 2',
    'apiLevel': '2.12'
}
...
def run(protocol: protocol_api.ProtocolContext):# labware for pipette tips
    ...
    well2 = protocol.load_labware('nest_96_wellplate_200ul_flat', location='4') # Chloroform reservoir, just another 96 well plate
